...
#import "ZzsAsiNetworkDelegate.h"

/**
 *  网络请求子项
 */
@interface ZzsAsiNetworkItem : NSObject

/**
 *  网络请求方式
 */
@property (nonatomic, assign) ZzsAsiNetWorkType networkType;
 ...
 *  网络请求的委托
 */
@property (nonatomic, assign) id<ZzsAsiNetworkDelegate>delegate;
/**
 *   target
 */
