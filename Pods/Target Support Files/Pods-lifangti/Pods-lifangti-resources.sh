...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_IMKit_SDK_v2_6_3_stable/RongCloud.bundle"
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_IMKit_SDK_v2_6_3_stable/en.lproj"
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_IMKit_SDK_v2_6_3_stable/zh-Hans.lproj"
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_IMKit_SDK_v2_6_3_stable/Emoji.plist"
  install_resource "RongCloudIMKit/Rong_Cloud_iOS_IMKit_SDK_v2_6_3_stable/RCConfig.plist"
